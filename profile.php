...
<head>
	<meta charset="utf-8">
	<title>kharid-bikri.com</title>
	<link rel="stylesheet" type="text/css" href="http://kenwheeler.github.io/slick/slick/slick.css"/>
	<link rel="stylesheet" type="text/css" href="http://kenwheeler.github.io/slick/slick/slick-theme.css"/>
	<link rel="stylesheet" type="text/css" href="assets/bootstrap-3.3.6-dist/css/bootstrap.css">
	<link rel="stylesheet" type="text/css" href="styles.css">
	<link rel="shortcut icon" href="assets/images/Capture.jpg">
</head>
<body>
	<div class="navbar navbar-default navbar-fixed-top"  id="topnav">
		<div class="container-fluid">
			<div class="navbar-header">
				<a href="index.php" class="navbar-brand"> Sell, Surf, Shop at kharidbikri.com</a>
			</div>
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<ul class="dropdown-menu">
					...
					<li><a href="manage.php"><span class="glyphicon glyphicon-shopping-cart-large"></span> Manage </a></li>
					<!--<li><a href="selling_form.php"><span class="glyphicon glyphicon-shopping-cart-large"></span> Sell</a></li>
	...
	<!-- Slider Begins -->
	 ...
	 <div class="one-time">
		...
		<div><img src="assets/images/slide1.jpg"></div>
